...
use App\Models\students_submissions;

class StudentSubmissionsController extends Controller
{
    //
    ...
    */
    ...
    {
        $students_submissions = students_submissions::orderBy('id','desc')->paginate(5);
