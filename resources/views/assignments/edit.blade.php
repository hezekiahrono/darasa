         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="date" name="due_date" value="{{ $assignment->due_date }}" class="form-control" placeholder="Due Date">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Image:</strong>
                    <input type="file" name="file_path" class="form-control" placeholder="document">
                    <img src="/images/{{ $assignment->file_path }}" width="300px">
                </div>
            </div>
